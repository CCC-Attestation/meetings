...
| --- | --- | --- | --- | --- |
| 2025-07-01 | Composite attesters | Binding TDISP & Platform Attestation Reports for Confidential VMs | Anna Trikalinou (@Anna-Trikalinou) | <ul><li>[slides](materials/AnnaTrikalinou_Binding_TDISP_and_Platform_Attestation_Evidence.pdf)</li></ul> |
